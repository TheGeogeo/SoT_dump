...
struct ABP_Placement_HeightDrop_C : AActor {
	...
	void CreateComponentList(); // Function BP_Placement_HeightDrop.BP_Placement_HeightDrop_C.CreateComponentList // Public|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
	void CreateParentBounds(); // Function BP_Placement_HeightDrop.BP_Placement_HeightDrop_C.CreateParentBounds // Public|HasDefaults|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
	void CheckMobilityState(); // Function BP_Placement_HeightDrop.BP_Placement_HeightDrop_C.CheckMobilityState // Public|HasDefaults|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
	void Get Valid Collision(struct TArray<struct FHitResult> Hit Results, bool Hit Success, struct USceneComponent* Current Component, bool Return Value, struct FVector Impact Position, struct FVector Impact Normal); // Function BP_Placement_HeightDrop.BP_Placement_HeightDrop_C.Get Valid Collision // Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
	void Drop Components(); // Function BP_Placement_HeightDrop.BP_Placement_HeightDrop_C.Drop Components // Public|HasDefaults|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
	void UserConstructionScript(); // Function BP_Placement_HeightDrop.BP_Placement_HeightDrop_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
};
