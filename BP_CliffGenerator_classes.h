...
struct ABP_CliffGenerator_C : AActor {
	...
	void Draw_Debug_Numbers(int32_t CurrentIndex, int32_t NextIndex, struct FVector StartLocation, struct FVector EndLocation, struct FVector StartTangent); // Function BP_CliffGenerator.BP_CliffGenerator_C.Draw_Debug_Numbers // Public|HasDefaults|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
	void Deform_Terrain(); // Function BP_CliffGenerator.BP_CliffGenerator_C.Deform_Terrain // Public|HasDefaults|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
	void Build_Element(int32_t Index, struct UStaticMesh* ElementMesh); // Function BP_CliffGenerator.BP_CliffGenerator_C.Build_Element // Public|HasDefaults|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
	void UserConstructionScript(); // Function BP_CliffGenerator.BP_CliffGenerator_C.UserConstructionScript // Event|Public|HasDefaults|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
};
