...
struct ABP_SmallShipStorageBarrel_Food_C : AStorageContainer {
	...
	void UserConstructionScript(); // Function BP_SmallShipStorageBarrel_Food.BP_SmallShipStorageBarrel_Food_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
};
