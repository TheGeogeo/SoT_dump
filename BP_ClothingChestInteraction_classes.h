...
struct ABP_ClothingChestInteraction_C : AClothingChestInteraction {
	...
	void UserConstructionScript(); // Function BP_ClothingChestInteraction.BP_ClothingChestInteraction_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e5fa0
};
