...
struct ABP_MultiShipCookingPot_C : ABP_CookingPotBase_C {
	...
	void UserConstructionScript(); // Function BP_MultiShipCookingPot.BP_MultiShipCookingPot_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e5fa0
};
