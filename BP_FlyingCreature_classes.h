...
struct ABP_FlyingCreature_C : AFlyingCreature {
	...
	void CreateCreature(); // Function BP_FlyingCreature.BP_FlyingCreature_C.CreateCreature // Public|HasDefaults|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
	void UserConstructionScript(); // Function BP_FlyingCreature.BP_FlyingCreature_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
};
