...
struct ABP_ShipStorageBarrel_Cannonball_C : AStorageContainer {
	...
	void UserConstructionScript(); // Function BP_ShipStorageBarrel_Cannonball.BP_ShipStorageBarrel_Cannonball_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
};
