...
struct ABP_LargeShip_Capstan_C : A {
	...
	void UserConstructionScript(); // Function BP_LargeShip_Capstan.BP_LargeShip_Capstan_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
};
