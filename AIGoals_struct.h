...
struct FBestActionSpotSelectionCriteria {
	...
	bool PreferActionSpotsCloserToSelf; // 0x1c(0x01)
	char UnknownData_1D[0x3]; // 0x1d(0x03)
	float MaximumDistanceAllowedFromTarget; // 0x20(0x04)
	bool ShouldAlwaysRefreshWhileOwnerMoving; // 0x24(0x01)
	bool ShouldRefreshAfterTargetMovesBeyondThreshold; // 0x25(0x01)
	char UnknownData_26[0x2]; // 0x26(0x02)
	float TargetMovementRefreshThresholdDistance; // 0x28(0x04)
	bool ShouldRefreshAfterStayingForTooLong; // 0x2c(0x01)
	char UnknownData_2D[0x3]; // 0x2d(0x03)
	float RefreshTimeInSeconds; // 0x30(0x04)
};
