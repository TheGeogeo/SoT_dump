...
struct ABP_ShipStorageBarrel_Wood_C : AStorageContainer {
	...
	bool ShouldDrawTooltipInWorldSpace(struct AActor** InInteractor, struct FVector* DesiredTooltipWorldPosition); // Function BP_ShipStorageBarrel_Wood.BP_ShipStorageBarrel_Wood_C.ShouldDrawTooltipInWorldSpace // Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent // @ game+0x18e5fa0
	void UserConstructionScript(); // Function BP_ShipStorageBarrel_Wood.BP_ShipStorageBarrel_Wood_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e5fa0
};
