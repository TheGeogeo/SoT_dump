...
struct ABP_WaterBarrel_C : AWaterBarrel {
	...
	void UserConstructionScript(); // Function BP_WaterBarrel.BP_WaterBarrel_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
};
