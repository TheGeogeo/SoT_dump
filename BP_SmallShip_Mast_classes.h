...
struct ABP_SmallShip_Mast_C : ABP_Mast_C {
	...
	void UserConstructionScript(); // Function BP_SmallShip_Mast.BP_SmallShip_Mast_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
	void OnMastDescLoaded(struct UMastDescAsset* MastDesc); // Function BP_SmallShip_Mast.BP_SmallShip_Mast_C.OnMastDescLoaded // Event|Public|BlueprintEvent // @ game+0x18e3b10
	void ExecuteUbergraph_BP_SmallShip_Mast(int32_t EntryPoint); // Function BP_SmallShip_Mast.BP_SmallShip_Mast_C.ExecuteUbergraph_BP_SmallShip_Mast //  // @ game+0x18e3b10
};
