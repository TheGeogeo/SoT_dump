...
struct ABP_ShipClothingChest_C : APossessionsChest {
	...
	void UserConstructionScript(); // Function BP_ShipClothingChest.BP_ShipClothingChest_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
};
