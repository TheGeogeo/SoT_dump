...
struct ABP_ShipCookingPot_C : ABP_CookingPotBase_C {
	...
	void UserConstructionScript(); // Function BP_ShipCookingPot.BP_ShipCookingPot_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
};
