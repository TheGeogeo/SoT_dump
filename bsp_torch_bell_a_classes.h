...
struct Absp_torch_bell_a_C : AStaticMeshActor {
	...
	void UserConstructionScript(); // Function bsp_torch_bell_a.bsp_torch_bell_a_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e5fa0
};
