...
struct ABP_CoralFortress_WeatherZone_C : AActor {
	...
	void IsLocalPlayer(struct AActor* Actor, bool Result); // Function BP_CoralFortress_WeatherZone.BP_CoralFortress_WeatherZone_C.IsLocalPlayer // Public|HasOutParms|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
	void OnRep_Opacity(); // Function BP_CoralFortress_WeatherZone.BP_CoralFortress_WeatherZone_C.OnRep_Opacity // BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
	void CreateDynamicMaterialAtSlot0(struct UPrimitiveComponent* Primitive, struct UMaterialInstanceDynamic* Material); // Function BP_CoralFortress_WeatherZone.BP_CoralFortress_WeatherZone_C.CreateDynamicMaterialAtSlot0 // Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure // @ game+0x18e3b10
	void UserConstructionScript(); // Function BP_CoralFortress_WeatherZone.BP_CoralFortress_WeatherZone_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
	void RainBlend__FinishedFunc(); // Function BP_CoralFortress_WeatherZone.BP_CoralFortress_WeatherZone_C.RainBlend__FinishedFunc // BlueprintEvent // @ game+0x18e3b10
	void RainBlend__UpdateFunc(); // Function BP_CoralFortress_WeatherZone.BP_CoralFortress_WeatherZone_C.RainBlend__UpdateFunc // BlueprintEvent // @ game+0x18e3b10
	void ReceiveBeginPlay(); // Function BP_CoralFortress_WeatherZone.BP_CoralFortress_WeatherZone_C.ReceiveBeginPlay // Event|Public|BlueprintEvent // @ game+0x18e3b10
	void StartRainBlend(); // Function BP_CoralFortress_WeatherZone.BP_CoralFortress_WeatherZone_C.StartRainBlend // BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
	void ReceiveEndPlay(char EndPlayReason); // Function BP_CoralFortress_WeatherZone.BP_CoralFortress_WeatherZone_C.ReceiveEndPlay // Event|Public|BlueprintEvent // @ game+0x18e3b10
	void StopRainBlend(); // Function BP_CoralFortress_WeatherZone.BP_CoralFortress_WeatherZone_C.StopRainBlend // BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
	...
	void ExecuteUbergraph_BP_CoralFortress_WeatherZone(int32_t EntryPoint); // Function BP_CoralFortress_WeatherZone.BP_CoralFortress_WeatherZone_C.ExecuteUbergraph_BP_CoralFortress_WeatherZone // HasDefaults // @ game+0x18e3b10
};
