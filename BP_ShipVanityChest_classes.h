...
struct ABP_ShipVanityChest_C : APossessionsChest {
	...
	void UserConstructionScript(); // Function BP_ShipVanityChest.BP_ShipVanityChest_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
};
