...
struct ABP_audio_prem_shop_wsp_C : AActor {
	...
	void UserConstructionScript(); // Function BP_audio_prem_shop_wsp.BP_audio_prem_shop_wsp_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
	void ReceiveBeginPlay(); // Function BP_audio_prem_shop_wsp.BP_audio_prem_shop_wsp_C.ReceiveBeginPlay // Event|Public|BlueprintEvent // @ game+0x18e3b10
	...
	void ExecuteUbergraph_BP_audio_prem_shop_wsp(int32_t EntryPoint); // Function BP_audio_prem_shop_wsp.BP_audio_prem_shop_wsp_C.ExecuteUbergraph_BP_audio_prem_shop_wsp // HasDefaults // @ game+0x18e3b10
};
