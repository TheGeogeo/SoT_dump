...
struct ABP_FrontendHUD_C : AFrontendHUD {
	...
	void UserConstructionScript(); // Function BP_FrontendHUD.BP_FrontendHUD_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e5fa0
};
