...
struct ABP_ReviveGhost_C : AReviveGhost {
	...
	void UserConstructionScript(); // Function BP_ReviveGhost.BP_ReviveGhost_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
};
