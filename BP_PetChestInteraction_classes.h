...
struct ABP_PetChestInteraction_C : APetChestInteraction {
	...
	void UserConstructionScript(); // Function BP_PetChestInteraction.BP_PetChestInteraction_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
};
