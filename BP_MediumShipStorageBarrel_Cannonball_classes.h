...
struct ABP_MediumShipStorageBarrel_Cannonball_C : AStorageContainer {
	...
	void UserConstructionScript(); // Function BP_MediumShipStorageBarrel_Cannonball.BP_MediumShipStorageBarrel_Cannonball_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
};
