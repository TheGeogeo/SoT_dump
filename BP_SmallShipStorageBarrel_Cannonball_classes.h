...
struct ABP_SmallShipStorageBarrel_Cannonball_C : AStorageContainer {
	...
	void UserConstructionScript(); // Function BP_SmallShipStorageBarrel_Cannonball.BP_SmallShipStorageBarrel_Cannonball_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
};
