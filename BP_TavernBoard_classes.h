...
struct ABP_TavernBoard_C : ATavernBoard {
	...
	void UserConstructionScript(); // Function BP_TavernBoard.BP_TavernBoard_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
	void ReceiveBeginPlay(); // Function BP_TavernBoard.BP_TavernBoard_C.ReceiveBeginPlay // Event|Public|BlueprintEvent // @ game+0x18e3b10
	void ExecuteUbergraph_BP_TavernBoard(int32_t EntryPoint); // Function BP_TavernBoard.BP_TavernBoard_C.ExecuteUbergraph_BP_TavernBoard //  // @ game+0x18e3b10
};
