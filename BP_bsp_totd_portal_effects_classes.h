...
struct ABP_bsp_totd_portal_effects_C : ABP_TotD_PortalController_C {
	...
	void UserConstructionScript(); // Function BP_bsp_totd_portal_effects.BP_bsp_totd_portal_effects_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
	void ReceiveBeginPlay(); // Function BP_bsp_totd_portal_effects.BP_bsp_totd_portal_effects_C.ReceiveBeginPlay // Event|Public|BlueprintEvent // @ game+0x18e3b10
	void ExecuteUbergraph_BP_bsp_totd_portal_effects(int32_t EntryPoint); // Function BP_bsp_totd_portal_effects.BP_bsp_totd_portal_effects_C.ExecuteUbergraph_BP_bsp_totd_portal_effects //  // @ game+0x18e3b10
};
