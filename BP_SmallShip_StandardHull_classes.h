...
struct ABP_SmallShip_StandardHull_C : AHull {
	...
	void UserConstructionScript(); // Function BP_SmallShip_StandardHull.BP_SmallShip_StandardHull_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
};
