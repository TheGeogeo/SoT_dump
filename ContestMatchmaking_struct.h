...
struct FContestMatchmakingServerRequestModel {
	...
	struct FGuid SaferSeasServerIdOverride; // 0x9c(0x10)
...
struct FServerCrewRequestModel {
	...
	int32_t CrewCount; // 0x88(0x04)
	int32_t CrewCountBucket; // 0x8c(0x04)
	int32_t CrewMin; // 0x90(0x04)
	int32_t CrewMax; // 0x94(0x04)
	struct TArray<int32_t> CrewSessionTypes; // 0x98(0x10)
	struct TArray<struct FExistingServerCrewModel> Crews; // 0xa8(0x10)
	struct FTimespan Uptime; // 0xb8(0x08)
	struct FServerContendedModel Contended; // 0xc0(0x30)
	struct FGameEventAvailabilityModel GameEvents; // 0xf0(0x20)
};
