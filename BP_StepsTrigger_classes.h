...
struct ABP_StepsTrigger_C : ATavernStepsTrigger {
	...
	void UserConstructionScript(); // Function BP_StepsTrigger.BP_StepsTrigger_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
	void ReceiveBeginPlay(); // Function BP_StepsTrigger.BP_StepsTrigger_C.ReceiveBeginPlay // Event|Public|BlueprintEvent // @ game+0x18e3b10
	void ExecuteUbergraph_BP_StepsTrigger(int32_t EntryPoint); // Function BP_StepsTrigger.BP_StepsTrigger_C.ExecuteUbergraph_BP_StepsTrigger //  // @ game+0x18e3b10
};
