...
struct ABP_DynamicDensityFog_Trigger_C : AActor {
	...
	void UserConstructionScript(); // Function BP_DynamicDensityFog_Trigger.BP_DynamicDensityFog_Trigger_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
	...
	void ExecuteUbergraph_BP_DynamicDensityFog_Trigger(int32_t EntryPoint); // Function BP_DynamicDensityFog_Trigger.BP_DynamicDensityFog_Trigger_C.ExecuteUbergraph_BP_DynamicDensityFog_Trigger // HasDefaults // @ game+0x18e3b10
};
