...
struct UBP_Anim_CharacterSelect_C : UThirdPersonAnimationInstance {
	...
	void BlueprintInitializeAnimation(); // Function BP_Anim_CharacterSelect.BP_Anim_CharacterSelect_C.BlueprintInitializeAnimation // Event|Public|BlueprintEvent // @ game+0x18e5fa0
	void AnimNotify_SelectedCameraZoom(); // Function BP_Anim_CharacterSelect.BP_Anim_CharacterSelect_C.AnimNotify_SelectedCameraZoom // BlueprintCallable|BlueprintEvent // @ game+0x18e5fa0
	void AnimNotify_BeginFade(); // Function BP_Anim_CharacterSelect.BP_Anim_CharacterSelect_C.AnimNotify_BeginFade // BlueprintCallable|BlueprintEvent // @ game+0x18e5fa0
	void ExecuteUbergraph_BP_Anim_CharacterSelect(int32_t EntryPoint); // Function BP_Anim_CharacterSelect.BP_Anim_CharacterSelect_C.ExecuteUbergraph_BP_Anim_CharacterSelect //  // @ game+0x18e5fa0
};
