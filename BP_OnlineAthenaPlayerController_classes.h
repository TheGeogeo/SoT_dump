...
struct ABP_OnlineAthenaPlayerController_C : AOnlineAthenaPlayerController {
	...
	void UserConstructionScript(); // Function BP_OnlineAthenaPlayerController.BP_OnlineAthenaPlayerController_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
};
