...
struct UBP_Anim_Contract_C : UWieldableItemAnimationInstance {
	...
	void OnUseStarted(struct UClass* InputID, struct FWieldableItemActionVisuals ActionVisuals); // Function BP_Anim_Contract.BP_Anim_Contract_C.OnUseStarted // Event|Public|HasOutParms|BlueprintEvent // @ game+0x18e3b10
	void OnUseStopped(struct UClass* InputID); // Function BP_Anim_Contract.BP_Anim_Contract_C.OnUseStopped // Event|Public|BlueprintEvent // @ game+0x18e3b10
	void ExecuteUbergraph_BP_Anim_Contract(int32_t EntryPoint); // Function BP_Anim_Contract.BP_Anim_Contract_C.ExecuteUbergraph_BP_Anim_Contract // HasDefaults // @ game+0x18e3b10
};
