...
struct AFireworkItemInfo : AItemInfo {
	struct ULoadableFireworkComponent* LoadableProjectileComponent; // 0x528(0x08)
	struct FStringAssetReference FireworkDataAsset; // 0x530(0x10)
	int32_t GeneratedDataRNGSeed; // 0x540(0x04)
