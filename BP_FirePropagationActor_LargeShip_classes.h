...
struct ABP_FirePropagationActor_LargeShip_C : AActor {
	...
	void UserConstructionScript(); // Function BP_FirePropagationActor_LargeShip.BP_FirePropagationActor_LargeShip_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
};
