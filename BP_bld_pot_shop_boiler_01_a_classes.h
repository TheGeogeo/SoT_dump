...
struct ABP_bld_pot_shop_boiler_01_a_C : AActor {
	...
	void UserConstructionScript(); // Function BP_bld_pot_shop_boiler_01_a.BP_bld_pot_shop_boiler_01_a_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e5fa0
};
