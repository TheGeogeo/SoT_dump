...
struct UAdventureOnDemandVoyageSelectionCompanyDataAsset : UDataAsset {
	...
	struct TArray<struct UInteractionPrerequisiteBase*> Prerequisites; // 0x38(0x10)
	struct TArray<struct FAdventureOnDemandVoyageSelectionVoyageProposalGroup> VoyageGroups; // 0x48(0x10)
	struct TArray<struct FAdventureOnDemandVoyageSelectionVoyageProposalGroup> WorldEventGroups; // 0x58(0x10)
};
...
struct UAdventureOnDemandTallTaleCategoryDataAsset : UDataAsset {
	...
	struct FStringAssetReference BackgroundImageUrl; // 0xa8(0x10)
	struct FStringAssetReference IconImageUrl; // 0xb8(0x10)
	struct TArray<struct FText> LockedDescriptions; // 0xc8(0x10)
	struct TArray<struct UInteractionPrerequisiteBase*> Prerequisites; // 0xd8(0x10)
	struct TArray<struct FAdventureOnDemandTallTaleProposalGroup> TallTales; // 0xe8(0x10)
};
...
struct UAdventureOnDemandVoyageSelectionDataAsset : UDataAsset {
	...
	struct TArray<struct UAdventureOnDemandVoyageSelectionCompanyDataAsset*> TallTaleChapters; // 0x40(0x10)
	struct TArray<struct UAdventureOnDemandTallTaleCategoryDataAsset*> TallTales; // 0x50(0x10)
};
...
struct UGameEventsOnDemandBannerDataAsset : UDataAsset {
	...
	struct TArray<struct FGameEventOnDemandCompanyBannerData> BannerTagsPerCompany; // 0x150(0x10)
};
