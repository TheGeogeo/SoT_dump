...
struct ABP_CosmeticOar_C : AActor {
	...
	void UserConstructionScript(); // Function BP_CosmeticOar.BP_CosmeticOar_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
};
