...
struct ABP_ShipStorageBarrelThree_C : AActor {
	...
	void UserConstructionScript(); // Function BP_ShipStorageBarrelThree.BP_ShipStorageBarrelThree_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
};
