...
struct ABP_MediumShip_StandardHull_C : AHull {
	...
	void UserConstructionScript(); // Function BP_MediumShip_StandardHull.BP_MediumShip_StandardHull_C.UserConstructionScript // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x18e3b10
};
