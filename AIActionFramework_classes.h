...
// Size: 0x28 (Inherited: 0x28)
struct UAIActionActivity_Follow : UAIActionActivity {
};
...
// Size: 0x28 (Inherited: 0x28)
struct UDockableRotationOverrideInterface : UInterface {
};

// Class AIActionFramework.DockableRotationOverrideComponent
// Size: 0xd8 (Inherited: 0xc8)
struct UDockableRotationOverrideComponent : UActorComponent {
	char UnknownData_C8[0x8]; // 0xc8(0x08)
	bool KeepOwnerRotationWhileDocked; // 0xd0(0x01)
